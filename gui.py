...
class Table1(Q.QWidget):
    def __init__(self):
        ...
        self.table.setHorizontalHeaderLabels(("Branch", "Type", "Customer", "Date"))
        # Create buttons
        self.branch = LineEdit("Branch")
        self.type = LineEdit("Type")
        self.customer = LineEdit("Customer")
        ...
        self.search_record = Q.QPushButton("Search by Customer")
...
class Ui(Q.QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.tabs.addTab(Table1(), "Services")
        self.tabs.addTab(Table2(), "Branches")
        self.tabs.addTab(Table3(), "Customers")
        self.tabs.addTab(Table4(), "Types of service")
        # Set layout
